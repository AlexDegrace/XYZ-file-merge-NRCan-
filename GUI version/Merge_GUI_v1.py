...
#   "PointCloud_RGB_NDRE_merge_vX" where X is the version. This version of the
#   GUI is for the version 4 or less.

class Root(Tk):
    
    def __init__(self):
        super(Root,self).__init__()
        self.merge = __import__('PointCloud_RGB_NDRE_merge_v4')
    ...
    def startProgramme(self):
        ...
        #create the tow list of points(RGb and NDRE
        ...
        self.merge.findPoints(NDREpoints, RGBpoints, self.filePathMerge, fileName)
