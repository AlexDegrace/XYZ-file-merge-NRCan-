...
#  and the NDRE of the tow file in one XYZ file. The final result is a XYz file that as
...
def findPoints(point1,point2):
    ...
    with open("P:/PointCloud_RGB_NDRE_merge/testBResult.xyz", 'a') as file:
        while(currentGroup != maxGroup):
            ...
            while(currentPoint != maxPoint):
                ...
                for i in range(comparisonNum):
                    #Formula that calculate how close is tow points
...
##NDREfile = input('Enter the path to the NDRE file: ')
##RGBfile = input('Enter the path to the RGB file: ')
##
##myTime = time.time()
##           
##NDREpoints = ListOfPoint(NDREfile)
##RGBpoints = ListOfPoint(RGBfile)
##
####P:/PointCloud_RGB_NDRE_merge/RGB_NDRE_indexCaculator_group1_densified_point_cloud_NDRE.xyz
####P:/PointCloud_RGB_NDRE_merge/RGB_NDRE_indexCaculator_group2_densified_point_cloud_RGB.xyz
##
##
##           
