...
class Root(Tk):
    ...
    def __init__(self):
        ...
        self.merge = __import__('PointCloud_RGB_NDRE_merge_v7')
        ...
        self.numberOfProcessing = Scale(self.fifthFrame, from_=1, to=10,orient=HORIZONTAL)
        ...
        self.startButton = Button(self.sixthFrame, text = 'Start', command=self.startProgramme, background="gray5", foreground = "white")
        self.startButton.pack(side = LEFT, padx = 10, pady=10)

        #This create the stop button
        self.endButton = Button(self.sixthFrame, text = 'Stop', command=self.merge.stopAll, background="gray5", foreground = "white")
    ...
    def startProgramme(self):
        ...
        self.merge.startProcessing(NDREpoints, RGBpoints, self.filePathMerge, fileName,self.numberOfProcessing.get())
        self.merge.mergeAll(self.filePathMerge,fileName,self.numberOfProcessing.get())
